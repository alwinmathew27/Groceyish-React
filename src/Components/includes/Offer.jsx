      ...
      <div className="relative w-full md:w-1/2 rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center p-4 md:p-8">
          <div className="text-left">
            ...
            <p className="text-xs sm:text-sm lg:text-lg mt-1 sm:mt-2 md:mt-2 text-[#838383] md:text-xs md:w-7/12 lg:w-8/12 max-[584px]:w-8/12">
              Shop $50 product and get free delivery anywhere.
            </p>
            <button className="mt-5 sm:mt-5 md:mt-3 lg:mt-6 xl:mt-9 bg-[#3bb77e] text-white px-3 sm:px-4 md:px-2 py-1.5 sm:py-2 md:py-2 text-xs sm:text-sm lg:text-[16px] md:text-sm  hover:bg-green-600 transition duration-300 flex items-center lg:p-[14px]">
              Shop Now <img src={Arrow} className="ml-2" alt="Arrow" />
            </button>
          </div>
        </div>
      </div>
      <div className="relative w-full md:w-1/2 rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center p-4 md:p-8">
          <div className="text-left">
            ...
            <p className="text-xs sm:text-sm lg:text-lg mt-1 sm:mt-2 md:mt-2 text-[#838383] md:text-xs md:w-2/3 lg:w-9/12 max-[584px]:w-8/12">
              Save up to 60% off on your first order
            </p>
            <button className="mt-5 sm:mt-5 md:mt-3 lg:mt-6 xl:mt-9 bg-[#3bb77e] text-white px-3 sm:px-4 md:px-2 py-1.5 sm:py-2 md:py-2 text-xs sm:text-sm lg:text-[16px]  md:text-sm hover:bg-green-600 transition duration-300 flex items-center lg:p-[14px]">
              Order Now <img src={Arrow} className="ml-2" alt="Arrow" />
            </button>
          </div>
        </div>
      </div>
